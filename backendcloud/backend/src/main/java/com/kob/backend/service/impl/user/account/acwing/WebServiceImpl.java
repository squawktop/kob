...
public class WebServiceImpl implements WebService {
    ...
    private final static String redirectUri = "https://app2703.acapp.acwing.com.cn/user/account/acwing/web/receive_code/";  //回调链接
    private final static String applyAccessTokenUrl = "https://www.acwing.com/third_party/api/oauth2/access_token/";  //回调链接
    private final static String getUserInfoUrl = "https://www.acwing.com/third_party/api/meta/identity/getinfo/";  //回调链接
    ...
    public JSONObject applyCode() {
        ...
        String applyCodeUrl = "https://www.acwing.com/third party/api/oauth2/web/authorize/?appid="
                + appId + "&redirect_uri=" + encodeUrl + "&scoped=userinfo" + "&state=" + state;
